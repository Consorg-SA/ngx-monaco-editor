# [FORK] Monaco Editor Component for Angular 11 ~~2 and above~~.
...
```
npm install monaco-editor @consorg/ngx-monaco-editor --save
 ```
...
import { MonacoEditorModule } from '@consorg/ngx-monaco-editor';
...
```typescript
import { Component } from '@angular/core';
import { DiffEditorModel } from '@consorg/ngx-monaco-editor';
...
import { MonacoEditorModule, NgxMonacoEditorConfig } from '@consorg/ngx-monaco-editor';
import { AppComponent } from './app.component';
...
Credit: [Atul Kumar](https://github.com/atularen)
